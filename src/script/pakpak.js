...
camera.position.set(26.70689641763228, 8.442637907607171, -0.26672457390479615);
camera.lookAt(0, 0, 0);
...
renderer.outputEncoding = THREE.sRGBEncoding; // Untuk warna lebih akurat
...
let light = new THREE.DirectionalLight(0xffe585, 1);
...
let pointLight = new THREE.PointLight(0xffffff, 30, 10, 2);
...
function load(color, isNight) {
  ...
  loader.load(
    ...
    function (gltf) {
      ...
      const targetCenter = new THREE.Vector3(14, 20, 8);
